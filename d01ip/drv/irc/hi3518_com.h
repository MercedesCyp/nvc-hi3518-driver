...
#define DEMOSAIC_SAT_SLOPE             (ISP_BASE + 0x0410)
#define DEMOSAIC_SAT_THRESH            (ISP_BASE + 0x0424)
#define DEMOSAIC_VH_OFFSET             (ISP_BASE + 0x0428)
#define DEMOSAIC_SAT_OFFSET            (ISP_BASE + 0x0438)
