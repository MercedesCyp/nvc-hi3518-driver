...
#define MUXCTRL_CRG14        (MUXCTRL_BASE + 0x0038)
#define MUXCTRL_CRG15        (MUXCTRL_BASE + 0x003C)
#define MUXCTRL_CRG16        (MUXCTRL_BASE + 0x0040)
#define MUXCTRL_CRG17        (MUXCTRL_BASE + 0x0044)
#define MUXCTRL_CRG18        (MUXCTRL_BASE + 0x0048)
#define MUXCTRL_CRG19        (MUXCTRL_BASE + 0x004C)
#define MUXCTRL_CRG20        (MUXCTRL_BASE + 0x0050)
#define MUXCTRL_CRG21        (MUXCTRL_BASE + 0x0054)
...
#define GPIO4_0          (GPIO4_BASE + (1 << (2 + 0)))
#define GPIO4_1          (GPIO4_BASE + (1 << (2 + 1)))
#define GPIO4_2          (GPIO4_BASE + (1 << (2 + 2)))
#define GPIO4_3          (GPIO4_BASE + (1 << (2 + 3)))
#define GPIO4_4          (GPIO4_BASE + (1 << (2 + 4)))
#define GPIO4_5          (GPIO4_BASE + (1 << (2 + 5)))
#define GPIO4_6          (GPIO4_BASE + (1 << (2 + 6)))
#define GPIO4_7          (GPIO4_BASE + (1 << (2 + 7)))
#define GPIO4_DIR        (GPIO4_BASE  + 0x400)
#define GPIO4_IS         (GPIO4_BASE  + 0x404)
#define GPIO4_IBE        (GPIO4_BASE  + 0x408)
#define GPIO4_IEV        (GPIO4_BASE  + 0x40C)
#define GPIO4_IE         (GPIO4_BASE  + 0x410)
#define GPIO4_RIS        (GPIO4_BASE  + 0x414)
#define GPIO4_MIS        (GPIO4_BASE  + 0x418)
#define GPIO4_IC         (GPIO4_BASE  + 0x41C)
