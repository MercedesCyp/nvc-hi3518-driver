...
#define GPIO2_0          (GPIO2_BASE + (1 << (2 + 0)))
#define GPIO2_1          (GPIO2_BASE + (1 << (2 + 1)))
#define GPIO2_2          (GPIO2_BASE + (1 << (2 + 2)))
#define GPIO2_3          (GPIO2_BASE + (1 << (2 + 3)))
#define GPIO2_4          (GPIO2_BASE + (1 << (2 + 4)))
#define GPIO2_5          (GPIO2_BASE + (1 << (2 + 5)))
#define GPIO2_6          (GPIO2_BASE + (1 << (2 + 6)))
#define GPIO2_7          (GPIO2_BASE + (1 << (2 + 7)))
#define GPIO2_DIR        (GPIO2_BASE  + 0x400)
#define GPIO2_IS         (GPIO2_BASE  + 0x404)
#define GPIO2_IBE        (GPIO2_BASE  + 0x408)
#define GPIO2_IEV        (GPIO2_BASE  + 0x40C)
#define GPIO2_IE         (GPIO2_BASE  + 0x410)
#define GPIO2_RIS        (GPIO2_BASE  + 0x414)
#define GPIO2_MIS        (GPIO2_BASE  + 0x418)
#define GPIO2_IC         (GPIO2_BASE  + 0x41C)
