...
//extern
//local
static mClass_CTA *sfPro_3518EV200_H04_WR_CONF(void);
static int32 sfPro_3518EV200_H04_Init(void);
static int32 sfPro_3518EV200_H04_Uninit(void);

#define H04_LDR_DLim			50
#define H04_LDR_NLim			30
...
static mGPIOPinIfo sH04_IfrFilter_Pin[] = {
	{3, 7, 20, 0x00},	// IRC switch
	{4, 0, 21, 0x00},	// IRC enable(N)
};

static mGPIOPinIfo sH04_IfrLED_Pin[] = {
	{4, 5, 26, 0x00},
};

static mGPIOPinIfo sH04_Button_Pin[] = {
	{7, 7, 63, 0x01},	// Wifi button
	{7, 0, 56, 0x00},	// Visitor button
	//{4, 6, 27, 0x00},     // Remove det
};

static mGPIOPinIfo sH04_StateLED_Pin[] = {
	{7, 3, 59, 0x01},	// State LED main
	{7, 2, 58, 0x01},	// State LED secend
};

static mGPIOPinIfo sH04_AudioPlug_Pin[] = {
	{8, 1, 65, 0x01},
};

static mGPIOPinIfo sH04_PIR_Pin[] = {
	{7, 4, 60, 0x01},	// PIR
};

static mGPIOPinIfo sH04_DoorBell_Pin[] = {
	{7, 1, 57, 0x00},	// Indoor bell
};

static mGPIOPinIfo sH04_DoorLock_Pin[] = {
	{4, 2, 23, 0x00},
};

static mGPIOPinIfo sH04_FM1288_Pin[] = {
	{3, 5, 18, 0x00},	// FM1288 IIC SCL
	{3, 6, 19, 0x00},	// FM1288 IIC SDA
};

/*
static uint8 u8H04_FM1288_InitData[870] = {
	//FM1288 Init Data
};
static uint32 u32H04_Fm1288_InitDataLen = sizeof(u8H04_FM1288_InitData);
*/

//global
mProInfo pgs3518EV200_H04_ProInfo = {
	.aPro = {.aKey = "H04", .aID = 0x1104,}
	,
	.aChip = {.aKey = "3518EV200", .aID = 0x3518E200,}
	,
	.aSubCmd = NULL,
	.afRewriteAndConfig = sfPro_3518EV200_H04_WR_CONF,
	.afInit = sfPro_3518EV200_H04_Init,
	.afUninit = sfPro_3518EV200_H04_Uninit,
};
