...
//extern
//local
static mClass_CTA *sfPro_3518E_G06_WR_CONF(void);
static int32 sfPro_3518E_G06_Init(void);
static int32 sfPro_3518E_G06_Uninit(void);
//global
...
//local
static mGPIOPinIfo sG06_Button_Pin[] = {
	{0, 1, 73, 0x00},
	{1, 7, 31, 0x00},
};

static mGPIOPinIfo sG06_StateLight_Pin[] = {
	{5, 2, 47, 0x00},
	{5, 3, 48, 0x00},
};

//global
mProInfo pgs3518E_G06_ProInfo = {
	.aPro = {.aKey = "G06", .aID = 0x1006,},
	.aChip = {.aKey = "3518E", .aID = 0x3518E,},
	.aSubCmd = NULL,
	.afRewriteAndConfig = sfPro_3518E_G06_WR_CONF,
	.afInit = sfPro_3518E_G06_Init,
	.afUninit = sfPro_3518E_G06_Uninit,
};
...
static mClass_CTA *sfPro_3518E_G06_WR_CONF(void)
{
	...
	tClassCTA->apButton->apPinArr->apPin = sG06_Button_Pin;
	tClassCTA->apButton->apPinArr->aNum = 2;
	// State Light
	tClassCTA->apStateLi = &gClassStateLi;
	tClassCTA->apStateLi->apPinArr->apPin = sG06_StateLight_Pin;
