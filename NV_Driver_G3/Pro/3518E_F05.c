...
#define DC_F05_PTZHStepsPerFull		672
#define DC_F05_PTZVStepsPerFull		157
#define DC_F05_PTZHLimSteps			690
#define DC_F05_PTZVLimSteps			170
...
//extern
//local
static mGPIOPinIfo s3518E_F05_StaLi_Pin[] = {
	{0, 3, 75, 0x00},
};
...
static mClass_CTA *sfPro_3518E_F05_WR_CONF(void)
{
	...
	tClassCTA->apStateLi->apPinArr->apPin = s3518E_F05_StaLi_Pin;
