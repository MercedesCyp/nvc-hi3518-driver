...
//extern
//local
static mClass_CTA *sfPro_3518E_F17_WR_CONF(void);
static int32 sfPro_3518E_F17_Init(void);
static int32 sfPro_3518E_F17_Uninit(void);
//global
...
//local
static mGPIOPinIfo sF17_Button_Pin[] = {
	{0, 1, 73, 0x00},
	{1, 7, 31, 0x00},
};
...
//global
mProInfo pgs3518E_F17_ProInfo = {
	.aPro = {.aKey = "F17", .aID = 0x0F17,},
	.aChip = {.aKey = "3518E", .aID = 0x3518E,},
	.aSubCmd = NULL,
	.afRewriteAndConfig = sfPro_3518E_F17_WR_CONF,
	.afInit = sfPro_3518E_F17_Init,
	.afUninit = sfPro_3518E_F17_Uninit,
};
...
static mClass_CTA *sfPro_3518E_F17_WR_CONF(void)
{
	...
	tClassCTA->apButton->apPinArr->apPin = sF17_Button_Pin;
