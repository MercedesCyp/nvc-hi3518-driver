...
#define DC_HAL_PIN_RetIntErr	0x01	//
	...
	uint32(*prfPin_CancelRegistInt)(uint32 iGrp, void (*iHandler)(void));	//
...
#define DC_HAL_PIN_IntDisable   0x10	//
...
typedef struct {		//
	...
	int32(*prfGCFPin)(mGPIOPinIfo *);	//Get Pwm Channel From input Pin Information
	void (*prfStart)(void);	//
