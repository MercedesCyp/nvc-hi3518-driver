#ifndef __HI3518EV200_HAL_H
#define __HI3518EV200_HAL_H
...
//关于中断的定义
///////////////////////////////////////////////////////////////////////////////
#define IRQ_SOFT			(0)	// Global Soft Interrupt
#define IRQ_WDT				(1)	// WatchDog
#define IRQ_RTC				(2)	// RTC
#define IRQ_TM0_TM1			(3)	// TIMER0 TIMER1
#define IRQ_TM2_TM3			(4)	// TIMER2 TIMER3
#define IRQ_UART0			(5)	// UART0
#define IRQ_SSP0			(6)	// SSP0
#define IRQ_SSP1			(7)	// SSP1
#define IRQ_GZIP_SDIO1			(8)	// GZIP/SDIO1
#define IRQ_AIAO			(9)	// AIAO
#define IRQ_USB_DEV			(10)	// USB_DEV
#define IRQ_FMC				(11)	// FMC
...
#define IRQ_SAR_ADC			(19)	// IR/SAR_ADC
#define IRQ_I2C				(20)	// I2C0/I2C1/I2C2
#define IRQ_IVE				(21)	// IVE
#define IRQ_VICAP			(22)	// VICAP
#define IRQ_VDP				(23)	// VDP
#define IRQ_AVC				(24)	// AVC
#define IRQ_UART2			(25)	// UART2
#define IRQ_JPGE			(26)	// JPGE
#define IRQ_TDE				(27)	// TDE
#define IRQ_MIPI			(28)	// MIPI
#define IRQ_VGS				(29)	// VGS
#define IRQ_UART1			(30)	// UART1
#define IRQ_GPIO31			(31)	// GPIO0~GPIO8
...
#define HAL_OFST_CRG31_RsTADC		HAL_OFST_CRG31_RsCIPHER
...
//ADC
#define HAL_BASE_LSADC				0x200B0000

#define HAL_OFST_ADC_CONFIG			0x00	// Ctrl0
#define HAL_OFST_ADC_GLITCH_SAMPLE		0x04	// Ctrl1
#define HAL_OFST_ADC_TIME_SCAN			0x08	// Ctrl2
#define HAL_OFST_ADC_RESULT_DATA		0x0C	// Ctrl3
#define HAL_OFST_ADC_INT_ENABLE			0x10	// Ctrl4
#define HAL_OFST_ADC_INT_STATUS			0x14	// Ctrl5
#define HAL_OFST_ADC_INT_CLR			0x18	// Ctrl6
#define HAL_OFST_ADC_START			0x1C	// Ctrl7
#define HAL_OFST_ADC_STOP			0x20	// Ctrl8

#define HAL_ADC_REGAddr(_ofst)		((_ofst)+HAL_BASE_LSADC)
...
#define DC_PIN_SET_IO_OUT(_g,_b,_MuxVal,_Mux)	\
	{ 	DF_Set_GPIO_MUXx((_MuxVal),(_Mux));\
		DF_Set_GPIO_DIRx( (_g), (_b));\
	}
#define DC_PIN_SET_IO_IN(_g,_b,_MuxVal,_Mux)	\
	{ 	DF_Set_GPIO_MUXx((_MuxVal),(_Mux));\
		DF_Clr_GPIO_DIRx( (_g), (_b));\
	}

#define DF_PIN_ClassifyGrp(_g)	\
	(( ((_g)==0) || ((_g)==1) || ((_g)==2) || ((_g)==11) )?0:\
	 (( ((_g)==3) || ((_g)==4) || ((_g)==5) || ((_g)==10) )?1:2))
// ---------------------------------------------------------------------->GPIO Macro

#endif				/* __HI3518EV200_HAL_H */
