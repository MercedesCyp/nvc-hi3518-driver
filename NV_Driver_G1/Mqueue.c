	...
	if( _i != DC_MQSpace_RmdMaxUser ){
		...
		if( tNodeTools != NULL ){
			if( tNodeTools->aLen > iMsgLen ){
				...
				gfStringCopy( piUserMsg, ((uint8*)tNodeTools + sizeof(mUMsgBody)), tNodeTools->aLen );
...
//		void                                                                    //
//////////////////////////////////////////////////////////////////////////////////
void gfInitMsgQueue(void *piSpace,uint32 iSize){
	
	psDataStart		= piSpace;
	psQueueStart	= piSpace + DC_MQSpace_ManageSize;
	psDataEnd 		= piSpace + iSize - 1;
	sDataSize		= iSize;
	//gfMemset( psDataStart, DC_MQDFC, iSize );
	gfMemset( psDataStart, DC_MQDFC, DC_MQSpace_ManageSize );
...
//		-4	unknow error		                                                //
//////////////////////////////////////////////////////////////////////////////////
int gfMsgQueue_addSubUser(uint32 iUID){
	int32 t32Rect;
...
//////////////////////////////////////////////////////////////////////////////////
int gfMsgQueue_delSubUser(uint32 iUID){
...
//////////////////////////////////////////////////////////////////////////////////
int gfIsSomeMsgExist(uint32 iUID){
//	int32 t32Ret;
...
//////////////////////////////////////////////////////////////////////////////////
int gfAddAUserMsgForSub(uint8 *piUserMsg, uint16 iMsgLen){
	uint8 		tUserMask = 0;
	uint16 		tSendLen;
	...
	
	{
		...
		tTools_mov = gfStringCopy(tTools_mov,(uint8*)&tMsgHead,sizeof(mUMsgBody) );
		tTools_mov = gfStringCopy(tTools_mov,(uint8*)piUserMsg,iMsgLen );
	...
	*ssManageHeader.aSubIdleBegin = tTools_mov;
	...
	if(gfMqueue_AddUserMsgCallBack)
		gfMqueue_AddUserMsgCallBack();
	return 0;
}
...
//	-1		no need report message , no subber user                             //
//////////////////////////////////////////////////////////////////////////////////
int gfAddAUserMsgForRmd(uint32 iUID, uint8 *piUserMsg, uint16 iMsgLen){
...
//////////////////////////////////////////////////////////////////////////////////
uint8 *gfGetMsgBlockAddress(void)
{
